...
class Order {
  ...
  factory Order.fromJson(Map<String, dynamic> json) => Order(
        ...
        localCurrencyAmount: json["localCurrencyAmount"] == null
            ? null
            : Amount.fromJson(json["localCurrencyAmount"]),
...
class OrderDetails {
  ...
  factory OrderDetails.fromJson(Map<String, dynamic> json) => OrderDetails(
        ...
        // json["Products"] == null
        //     ? []
        //     : List<List<List<List<dynamic>>>>.from(json["Products"]!.map((x) =>
        //         List<List<List<dynamic>>>.from(x.map((x) =>
  ...
  Map<String, dynamic> toJson() => {
        ...
        "Products": products == null
            ? []
            : List<dynamic>.from(products!.map((x) => List<dynamic>.from(x.map(
                (x) => List<dynamic>.from(
                    x.map((x) => List<dynamic>.from(x.map((x) => x)))))))),
